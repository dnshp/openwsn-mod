...
// PA2
void debugpins_gpio1_toggle() {
	bspDBpinToggle(BSP_PINA_BASE, BSP_PINA_2);
}

void debugpins_gpio1_clr() {
	GPIOPinWrite(BSP_PINA_BASE, BSP_PINA_2, 0);
}

void debugpins_gpio1_set() {
	GPIOPinWrite(BSP_PINA_BASE, BSP_PINA_2, BSP_PINA_2);
}

// PA3
void debugpins_gpio2_toggle() {
        bspDBpinToggle(BSP_PINA_BASE, BSP_PINA_3);
}

void debugpins_gpio2_clr() {
        GPIOPinWrite(BSP_PINA_BASE, BSP_PINA_3, 0);
}

void debugpins_gpio2_set() {
        GPIOPinWrite(BSP_PINA_BASE, BSP_PINA_3, BSP_PINA_3);
}

// PB2
void debugpins_gpio3_toggle() {
        bspDBpinToggle(BSP_PINB_BASE, BSP_PINB_2);
}

void debugpins_gpio3_clr() {
        GPIOPinWrite(BSP_PINB_BASE, BSP_PINB_2, 0);
}

void debugpins_gpio3_set() {
        GPIOPinWrite(BSP_PINB_BASE, BSP_PINB_2, BSP_PINB_2);
}

// PB5
void debugpins_gpio4_toggle() {
        bspDBpinToggle(BSP_PINB_BASE, BSP_PINB_5);
}

void debugpins_gpio4_clr() {
        GPIOPinWrite(BSP_PINB_BASE, BSP_PINB_5, 0);
}

void debugpins_gpio4_set() {
        GPIOPinWrite(BSP_PINB_BASE, BSP_PINB_5, BSP_PINB_5);
}
